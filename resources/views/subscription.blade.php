            ...
            <div class="card pb-3 mb-5">
                ...
                <div class="row p-1 mx-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <p class="btn rounded-5 py-3 px-5 fw-bolder" style="--bs-btn-border-color: #6f42c1; --bs-btn-hover-bg: rgba(111,66,193,0.47)">Select</p>
                        </div>
            ...
            <div class="card pb-3 mb-5">
                ...
                <div class="row p-1 mx-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <p class="btn rounded-5 py-3 px-5 fw-bolder" style="--bs-btn-border-color: #00EC34; --bs-btn-hover-bg: rgba(0,236,52,0.56)">Select</p>
                        </div>
